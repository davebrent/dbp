...
,
		"rect" : [ 452.0, 58.0, 440.0, 471.0 ],
		"bglocked" : 0,
		"defrect" : [ 452.0, 58.0, 440.0, 471.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"text" : "send~ Rout",
					"fontsize" : 9.0,
					"patching_rect" : [ 175.0, 370.0, 55.0, 17.0 ],
					"numinlets" : 1,
					"id" : "obj-1",
					"fontname" : "Arial",
					"numoutlets" : 0
...
, 			{
				"box" : 				{
					...
					"text" : "send~ Lout",
					"fontsize" : 9.0,
					"patching_rect" : [ 112.0, 370.0, 55.0, 17.0 ],
					"numinlets" : 1,
					"id" : "obj-2",
					"fontname" : "Arial",
					"numoutlets" : 0
...
, 			{
				"box" : 				{
					...
					"text" : "sah~ 0.",
					"fontsize" : 9.0,
					"patching_rect" : [ 278.0, 205.0, 41.0, 17.0 ],
					"numinlets" : 2,
					"id" : "obj-5",
					"fontname" : "Arial",
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"text" : "r gain",
					"fontsize" : 9.0,
					"patching_rect" : [ 151.0, 286.0, 34.0, 17.0 ],
					"numinlets" : 0,
					"id" : "obj-10",
					"fontname" : "Arial",
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"text" : "r gfreq",
					"fontsize" : 9.0,
					"patching_rect" : [ 129.0, 50.0, 40.0, 17.0 ],
					"numinlets" : 0,
					"id" : "obj-11",
					"fontname" : "Arial",
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"text" : "receive~ gdur",
					"fontsize" : 9.0,
					"patching_rect" : [ 158.0, 135.0, 71.0, 17.0 ],
					"numinlets" : 1,
					"id" : "obj-12",
					"fontname" : "Arial",
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"text" : "receive~ pos",
					"fontsize" : 9.0,
					"patching_rect" : [ 35.0, 84.0, 65.0, 17.0 ],
					"numinlets" : 1,
					"id" : "obj-13",
					"fontname" : "Arial",
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"fontsize" : 9.0,
					"patching_rect" : [ 112.0, 239.0, 83.0, 17.0 ],
					"numinlets" : 1,
					"id" : "obj-16",
					"fontname" : "Arial",
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"linecount" : 2,
					"fontsize" : 9.0,
					"patching_rect" : [ 195.0, 40.0, 86.0, 27.0 ],
					"numinlets" : 1,
					"id" : "obj-23",
					"fontname" : "Arial",
					"numoutlets" : 0
...
, 			{
				"box" : 				{
					...
					"linecount" : 6,
					"fontsize" : 9.0,
					"patching_rect" : [ 0.0, 150.0, 101.0, 69.0 ],
					"numinlets" : 1,
					"id" : "obj-25",
					"fontname" : "Arial",
					"numoutlets" : 0
...
, 			{
				"box" : 				{
					...
					"linecount" : 3,
					"fontsize" : 9.0,
					"patching_rect" : [ 227.0, 110.0, 98.0, 38.0 ],
					"numinlets" : 1,
					"id" : "obj-26",
					"fontname" : "Arial",
					"numoutlets" : 0
