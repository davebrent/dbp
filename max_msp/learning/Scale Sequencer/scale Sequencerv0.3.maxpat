	...
	"patcher" : 	{
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"fontface" : 1,
					"fontsize" : 12.0,
					"patching_rect" : [ 855.0, 75.0, 46.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"fontsize" : 12.0,
					"patching_rect" : [ 885.0, 135.0, 50.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 1,
					"patching_rect" : [ 825.0, 75.0, 20.0, 20.0 ],
					"outlettype" : [ "int" ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"fontsize" : 12.0,
					"patching_rect" : [ 825.0, 105.0, 52.0, 20.0 ],
					"outlettype" : [ "bang", "" ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"fontsize" : 12.0,
					"patching_rect" : [ 585.0, 255.0, 52.0, 20.0 ],
					"outlettype" : [ "bang", "" ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 105.0, 240.0, 473.0, 34.0 ],
					"outlettype" : [ "", "" ],
					"setminmax" : [ 0.0, 1.0 ],
					"size" : 16
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"fontsize" : 12.0,
					"patching_rect" : [ 645.0, 255.0, 84.0, 20.0 ],
					"outlettype" : [ "signal" ],
					"patcher" : 					{
						"fileversion" : 1,
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "float", "", "", "bang" ],
									"addpoints" : [ 0.0, 0.0, 0, 10.638298, 0.68, 0, 79.787231, 0.0, 0, 111.702126, 0.0, 0, 281.914886, 0.0, 0, 1000.0, 0.0, 0 ]
								}
...
, 							{
								"box" : 								{
									...
									"autoout" : 1,
									"nfilters" : 1,
									"setfilter" : [ 0, 2, 0, 0, 0, 2749.0, 1.0, 0.5, 0.0001, 22050.0, 0.0001, 16.0, 0.5, 25.0 ]
								}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"fontsize" : 12.0,
					"patching_rect" : [ 645.0, 210.0, 77.0, 20.0 ],
					"outlettype" : [ "signal" ],
					"patcher" : 					{
						"fileversion" : 1,
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "float", "", "", "bang" ],
									"addpoints" : [ 0.0, 0.0, 0, 10.638298, 1.0, 0, 430.851074, 0.0, 0, 707.446838, 0.0, 0, 707.446838, 0.0, 0, 707.446838, 0.0, 0, 707.446838, 0.0, 0, 707.446838, 0.0, 0, 829.787231, 0.0, 0 ]
								}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"fontsize" : 12.0,
					"patching_rect" : [ 585.0, 210.0, 52.0, 20.0 ],
					"outlettype" : [ "bang", "" ]
				}
...
, 			{
				"box" : 				{
					...
					"settype" : 0,
					"slidercolor" : [ 0.258824, 0.258824, 0.258824, 1.0 ],
					"patching_rect" : [ 105.0, 195.0, 473.0, 34.0 ],
					"outlettype" : [ "", "" ],
					"setminmax" : [ 0.0, 1.0 ],
					"size" : 16
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 855.0, 300.0, 45.0, 45.0 ]
				}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "float", "", "", "bang" ],
									"addpoints" : [ 0.0, 0.0, 0, 16.018354, 0.578125, 0, 873.0, 0.0, 0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "float", "", "", "bang" ],
									"addpoints" : [ 0.0, 0.0, 0, 16.018354, 17.625, 0, 873.0, 0.0, 0 ]
								}
...
, 			{
				"box" : 				{
					...
					"settype" : 0,
					"slidercolor" : [ 0.258824, 0.258824, 0.258824, 1.0 ],
					"patching_rect" : [ 105.0, 105.0, 472.0, 78.0 ],
					"outlettype" : [ "", "" ],
					"setminmax" : [ 1.0, 9.0 ],
					"size" : 16
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-4", 0 ],
					"hidden" : 0,
					"midpoints" : [ 567.5, 183.0, 660.0, 183.0, 660.0, 102.0, 684.5, 102.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-6", 1 ],
					"hidden" : 0,
					"midpoints" : [ 567.5, 183.0, 660.0, 183.0, 660.0, 72.0, 624.5, 72.0 ]
				}
