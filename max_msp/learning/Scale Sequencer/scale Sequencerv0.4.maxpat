{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 292.0, 44.0, 952.0, 730.0 ],
		"bglocked" : 0,
		"defrect" : [ 292.0, 44.0, 952.0, 730.0 ],
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "select 1",
					"patching_rect" : [ 585.0, 570.0, 52.0, 20.0 ],
					"id" : "obj-105",
					"numinlets" : 2,
					"fontname" : "Arial",
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 105.0, 570.0, 473.0, 34.0 ],
					"id" : "obj-106",
					"settype" : 0,
					"numinlets" : 1,
					"spacing" : 2,
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "open",
					"patching_rect" : [ 645.0, 570.0, 37.0, 18.0 ],
					"id" : "obj-107",
					"numinlets" : 2,
					"fontname" : "Arial",
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "sfplay~",
					"patching_rect" : [ 645.0, 600.0, 49.0, 20.0 ],
					"id" : "obj-108",
					"numinlets" : 2,
					"fontname" : "Arial",
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					"maxclass" : "number",
					"patching_rect" : [ 585.0, 540.0, 50.0, 20.0 ],
					"id" : "obj-98",
					"numinlets" : 1,
					"fontname" : "Arial",
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "select 1",
					"patching_rect" : [ 585.0, 510.0, 52.0, 20.0 ],
					"id" : "obj-99",
					"numinlets" : 2,
					"fontname" : "Arial",
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					...
					"setstyle" : 1,
					"bordercolor" : [ 0.258824, 0.258824, 0.258824, 1.0 ],
					"patching_rect" : [ 105.0, 510.0, 473.0, 34.0 ],
					"id" : "obj-100",
					"settype" : 0,
					"numinlets" : 1,
					"spacing" : 2,
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "open",
					"patching_rect" : [ 645.0, 510.0, 37.0, 18.0 ],
					"id" : "obj-101",
					"numinlets" : 2,
					"fontname" : "Arial",
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "sfplay~",
					"patching_rect" : [ 645.0, 540.0, 49.0, 20.0 ],
					"id" : "obj-102",
					"numinlets" : 2,
					"fontname" : "Arial",
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "LEAD",
					"patching_rect" : [ 30.0, 150.0, 59.0, 25.0 ],
					"id" : "obj-53",
					"numinlets" : 1,
					"fontname" : "Arial",
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "HAT",
					"patching_rect" : [ 30.0, 345.0, 59.0, 25.0 ],
					"id" : "obj-52",
					"numinlets" : 1,
					"fontname" : "Arial",
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "KICK",
					"patching_rect" : [ 30.0, 300.0, 59.0, 25.0 ],
					"id" : "obj-51",
					"numinlets" : 1,
					"fontname" : "Arial",
					"numoutlets" : 0,
...
, 											{
												"box" : 												{
													...
													"pointcolor" : [ 0.321569, 0.321569, 0.321569, 1.0 ],
													"domain" : 127.0,
													"addpoints" : [ 0.0, 0.0, 0, 2.330269, 0.734375, 0, 93.210876, 0.0, 0 ]
												}
...
, 											{
												"box" : 												{
													...
													"pointcolor" : [ 0.321569, 0.321569, 0.321569, 1.0 ],
													"domain" : 127.0,
													"addpoints" : [ 0.0, 0.0, 0, 2.330271, 17.625, 0, 5.825688, 0.0, 0 ]
												}
...
, 			{
				"box" : 				{
					"maxclass" : "ezdac~",
					"patching_rect" : [ 825.0, 330.0, 45.0, 45.0 ],
					"id" : "obj-12",
					"numinlets" : 2,
					"numoutlets" : 0
				}
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "SCALE SEQUENCER v0.4",
					"patching_rect" : [ 15.0, 45.0, 224.0, 25.0 ],
					"id" : "obj-117",
					"numinlets" : 1,
					"fontname" : "Arial",
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "SUB",
					"patching_rect" : [ 30.0, 225.0, 59.0, 25.0 ],
					"id" : "obj-112",
					"numinlets" : 1,
					"fontname" : "Arial",
					"numoutlets" : 0,
